"""
Live bargaining system for the Hybrid_Chatbot system.
"""
...
class LiveBargainingSystem:
    ...
    async def respond_to_non_offer(self, evaluation: str, greedy: int, message: str, llm_client: LLMClient)-> str:
        # Difference between Version 1.0 and 1.1 here we always check the LLM output.
    ...
    async def handle_negotiation_message(self, message: str, llm_client: LLMClient) -> str:
       ...
       # print(f"Greediness: {greedy}")
        ...
        if evaluation == ACCEPT:
            ...
            return await self.respond_to_non_offer(evaluation,greedy,message, llm_client)
        else:
            raise Exception
